...
const Navbar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      dropdown: true,
      items: [
        { label: 'Graphic Design', path: '/services/graphic-design', icon: LayoutGrid },
        { label: 'Digital Products', path: '/services/digital-products', icon: Cloud },
        { label: 'Social Marketing', path: '/services/social-marketing', icon: MessagesSquare },
        { label: 'Brand Strategy', path: '/services/brand-strategy', icon: LayoutGrid },
        { label: 'Product Development', path: '/services/product-development', icon: Cloud },
        { label: 'Consulting', path: '/services/consulting', icon: MessagesSquare },
      ],
    },
